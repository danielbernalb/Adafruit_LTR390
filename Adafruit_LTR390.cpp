...
//  float fUVI = (float)(uv_data * (1 << (20 - (int)resolution))); // scale up to 20-bits of resolution
  float fUVI = (float)(uv_data << (20 - (int)resolution)); // scale up to 20-bits of resolution
